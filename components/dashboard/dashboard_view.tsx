...
import { formatNumber, formatWholeNumberWithCommas, firstTwoLower } from "@/lib/utils";
              ...
              {Object.entries(data?.tvlStrategies).map(([strategy, value]) => (
                ...
                <div key={strategy} className="flex items-center gap-4">
                  <Avatar className="hidden h-9 w-9 sm:flex">
                    ...
                    <AvatarFallback>{firstTwoLower(strategy)}
                    </AvatarFallback>
                  </Avatar>
                  ...
                  <div className="ml-auto font-medium">$ {formatNumber(value)}</div>
                </div>
              ))}
